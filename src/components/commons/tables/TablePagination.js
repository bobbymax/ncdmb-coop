    ...
    <>
      <nav aria-label="Page navigation example">
        <ul className="pagination justify-content-end">
          ...
          >
            <Link className="page-link" to="#" onClick={() => onPageChange(1)}>
              1
            </Link>
          </li>
          <li
            className={`page-item ${page === 2 && "active"} ${
              page === 2 || page === totalPages ? "disabled" : ""
            }`}
          >
            <Link className="page-link" to="#" onClick={() => onPageChange(2)}>
              2
            </Link>
          </li>
          <li
            className={`page-item ${page === 3 && "active"} ${
              page === 3 || page === totalPages ? "disabled" : ""
            }`}
          >
            <Link className="page-link" to="#" onClick={() => onPageChange(3)}>
              3
            </Link>
          </li>
          <li
          ...
          >
            ...
            >
              <span aria-hidden="true" style={{ color: next }}>
                &raquo;
              </span>
